...
document.addEventListener("DOMContentLoaded", function() {
    ...
    contactForm.addEventListener("submit", async function(e) {
        ...
        formSuccess.style.color = "#000";
        formSuccess.innerText = "Submitting...";
        ...
        try {
            ...
            if (response.ok) {
                ...
                formSuccess.innerText = "✅ Message Sent Successfully!";
                contactForm.reset();
            } else {
                formSuccess.style.color = "red";
                formSuccess.innerText = result.message || "❌ Something went wrong!";
            }
        } catch (error) {
            formSuccess.style.color = "red";
            formSuccess.innerText = "❌ Network Error! Please try again.";
        }
    });
});
	// Service Slider
 ...
 const slider = document.getElementById("clientTrack");
